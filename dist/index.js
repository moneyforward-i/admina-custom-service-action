...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const Integration = __importStar(__nccwpck_require__(626));
...
exports.Sync = void 0;
// Source
const AzureAdSource = __importStar(__nccwpck_require__(8917));
// Transform
const AzureAdTransform = __importStar(__nccwpck_require__(8566));
// Destination
...
const syncToAdmina = (source, inputs) => __awaiter(void 0, void 0, void 0, function* () {
    switch (source) {
        case enum_1.Source.AzureAd:
            ...
            if (errors.length > 0) {
                throw new Error("The syncing process couldn't finish completely, please check the errors");
            }
            break;
        default:
...
class AzureAD {
    ...
    getEnterpriseApplications(accessToken, serviceNames = [], baseURL = 'https://graph.microsoft.com/v1.0/applications') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const appInfoKeys = ['appId', 'displayName', 'signInAudience', 'identifierUris', 'tags'];
            // 型ガード関数を定義
            const isAppInfo = (obj) => {
            ...
            let appInfos = [];
            const { results, errors } = yield promise_pool_1.PromisePool
                .for(apps.filter(isAppInfo)) // 型ガードでフィルタリング
                .withConcurrency(5) // 並列数を5に制限
            ...
            if (errors.length > 0) {
                throw new Error("Fail to fetch application details, please check the errors");
            }
            appInfos = results;
    ...
    fetchSsoApps() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const enterpriseApplications = yield this.getEnterpriseApplications(accessToken, this.target_services);
                console.log(`Detected ${enterpriseApplications.length} SSO apps`);
                let filteredResults = [];
                const { results, errors } = yield promise_pool_1.PromisePool
                    .for(enterpriseApplications)
                    .withConcurrency(5) // 並列数を5に制限
                    .process(appInfo => this.getAppInfos(accessToken, appInfo).catch(err => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.transformDataToAdmina = void 0;
